 ...
 */
#define E0_AUTO_FAN_PIN PB0 //LMaker Fan HE1
...
#define HOME_Y_BEFORE_X                     // If G28 contains XY home Y before X //LMaker
...
//
#define ASSISTED_TRAMMING //Pouteau
   ...
   */
  #define TRAMMING_SCREW_THREAD 30 //LMaker
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define SOUND_MENU_ITEM   // Add a mute option to the LCD menu //LMaker
  #define SOUND_ON_DEFAULT    // Buzzer/speaker default enabled state
#endif

#if EITHER(HAS_DISPLAY, DWIN_LCD_PROUI)
  // The timeout to return to the status screen from sub-menus
  #define LCD_TIMEOUT_TO_STATUS 15000   // (ms) //LMaker
  ...
  #define STATUS_MESSAGE_SCROLLING //LMaker

  // Apply a timeout to low-priority status messages
  //#define STATUS_MESSAGE_TIMEOUT_SEC 30 // (seconds)

  // On the Info Screen, display XY with one decimal place when possible
  #define LCD_DECIMAL_SMALL_XY //LMaker
  #define LCD_SET_PROGRESS_MANUALLY //LMaker
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G27"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27") //LMaker
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //LMaker
  ...
  #define UTF_FILENAME_SUPPORT //LMaker

  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L' //LMaker
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>' //LMaker
...
//
  ...
  #define LCD_LANGUAGE_2 es //LMaker
  #define LCD_LANGUAGE_3 de
  #define LCD_LANGUAGE_4 fr
  #define LCD_LANGUAGE_5 it
  #ifdef LCD_LANGUAGE_2
    #define LCD_LANGUAGE_AUTO_SAVE // Automatically save language to EEPROM on change //LMaker
  #endif
#endif
 ...
 */
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping. //LMaker
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28 //LMaker
 ...
 */
#define ADVANCED_PAUSE_FEATURE //LMaker
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         35  // (mm/s) Initial retract feedrate. //LMaker
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract. //LMaker
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     20  // (mm/s) Unload filament feedrate. This can be pretty fast. //LMaker
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   2  // (mm/s) Slow move when starting load. //LMaker
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    10  // (mm) Slow length, to allow time to insert material. //LMaker
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   5  // (mm/s) Load filament feedrate. This can be pretty fast. //LMaker
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     10  // (mm/s^2) Lower acceleration may allow a faster feedrate. //LMaker
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    40  // (mm) Load length of filament, from extruder gear to nozzle. //LMaker
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         30  // (mm) Length to extrude after loading. //LMaker
                                                  //   Set to 0 for manual extrusion.
                                                  //   Filament can be extruded repeatedly from the Filament Change menu
                                                  //   until extrusion is consistent, and to purge old filament.
  #define ADVANCED_PAUSE_RESUME_PRIME          0  // (mm) Extra distance to prime nozzle after returning from park.
  #define ADVANCED_PAUSE_FANS_PAUSE               // Turn off print-cooling fans while the machine is paused. //LMaker

                                                  // Filament Unload does a Retract, Delay, and Purge first:
  #define FILAMENT_UNLOAD_PURGE_RETRACT        6  // (mm) Unload initial retract length. //LMaker
  #define FILAMENT_UNLOAD_PURGE_DELAY       5000  // (ms) Delay for the filament to cool after retract. //LMaker
  #define FILAMENT_UNLOAD_PURGE_LENGTH         8  // (mm) An unretract is done, then this length is purged.//LMaker
  #define FILAMENT_UNLOAD_PURGE_FEEDRATE       6  // (mm/s) feedrate to purge before unload //LMaker

  #define PAUSE_PARK_NOZZLE_TIMEOUT           80  // (seconds) Time limit before the nozzle is turned off for safety. //LMaker
  #define FILAMENT_CHANGE_ALERT_BEEPS          5  // Number of alert beeps to play when a response is needed. //LMaker
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change. //LMaker
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu. //LMaker
